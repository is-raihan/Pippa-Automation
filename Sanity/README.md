# Sanity Testing Suite

This directory contains sanity tests for the Pippa project using Playwright and Cucumber for BDD (Behavior Driven Development).
...
- `features/` - Contains Cucumber feature files
  - `*.feature` - Feature files written in Gherkin
...
6. Use page objects for better maintainability
7. Handle test data appropriately
